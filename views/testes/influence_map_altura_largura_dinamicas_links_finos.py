...
def _auto_size_sankey(nodes, links, root_label,
                      base_h=420, px_per_branch=60, h_min=420, h_max=1600,
                      base_w=720, px_per_level=220, w_min=640, w_max=2000):
    """Estimate height from max breadth; width from depth."""
    ...
    w = base_w + px_per_level * max_depth
...
# (o radio já atualiza esta key por nós)
    ...
    with col_plot:
        ...
        h, w = _auto_size_sankey(nodes, links, root_for_depth)
